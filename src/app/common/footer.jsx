...
class SimpleEmailSignup extends Component {
	constructor(props) {
		super(props)
	...
	render() {
		return (
			<form
				action="https://getradplaid.us17.list-manage.com/subscribe/post?u=29bf1347cfc1063917d7993ff&amp;id=e57f2984a3"
				method="post"
				id="mc-embedded-subscribe-form"
				name="mc-embedded-subscribe-form"
				className="form-email validate"
				target="_blank"
				noValidate>

				<h3 className="typography-small-headline text-uppercase">Want Rad Plaid in your town?</h3>
				<ul id="mc_embed_signup_scroll" className="form-table form-table--simple">
					<li className="mc-field-group" style={{ transform: 'translateZ(0)' }}>
						<label className="form-label form-label--center" htmlFor="mce-EMAIL">Email</label>
						<input type="email" value={this.state.email} onChange={this.onInputChange} placeholder="Email address" autoComplete="email" name="EMAIL" className="form-input text-right required email" id="mce-EMAIL" />
						<div className="form-focus"></div>
					</li>

					<li className="mc-field-group" style={{ transform: 'translateZ(0)' }}>
						<label className="form-label form-label--center" htmlFor="mce-ZIPCODE">Zip/Postal</label>
						<input type="text" value={this.state.zipcode} onChange={this.onInputChange} placeholder="Zip/Postal Code" autoComplete="postal-code" name="ZIPCODE" className="form-input text-right" id="mce-ZIPCODE" />
						<div className="form-focus"></div>
					</li>
					<li className="mc-field-group form-input--hidden">
						<input type="hidden" value={this.state.reason} onChange={this.onInputChange} name="REASON" className="form-input text-right" id="mce-REASON" />
					</li>
					...
					<div style={{ position: 'absolute', left: '-5000px' }} aria-hidden="true">
						<input type="text" name="b_29bf1347cfc1063917d7993ff_e57f2984a3" autoComplete="off" tabIndex="-1" value="" readOnly />
					</div>
				</ul>

				<input type="submit" value="Join the Waitlist" name="subscribe" id="mc-embedded-subscribe" className="btn btn--accent widthfull" />
			</form>
		)
	}
}
...
class Footer extends Component {
	...
	onChangePage(evt) {
		...
		if (!this.props.user || name === 'signup') {
			return this.props.history.push(`${uri.pathname()}?modal=signup`)
		}
	...
	render() {
		let { loadStart, viewportName } = this.props

		return (viewportName === 'small' ? (
			<footer>
				<div className="grid">
					<AppDownload theme="dark" />
					<br />
					<div className="row">
						...
						<Accordion>
							<AccordionItem>
								<AccordionItemHeading>
									<AccordionItemButton>
										<IconRemove className="icon-remove inlineblock" />
										<IconPlus className="icon-plus inlineblock" /> Company
									</AccordionItemButton>
								</AccordionItemHeading>
								<AccordionItemPanel>
									<ul className="col col-3-of-12 col-small-12-of-12 links list">
										{!this.props.user && (
											<React.Fragment>
												<li><a href="#" onClick={this.onChangePage} name="signup">{SIGNUP_BUTTON}</a></li>
												<li>
													<Login
							...
							<AccordionItem>
								<AccordionItemHeading>
									<AccordionItemButton>
										<IconRemove className="icon-remove inlineblock" />
										<IconPlus className="icon-plus inlineblock" /> Artists &amp; Venues
									</AccordionItemButton>
								</AccordionItemHeading>
								<AccordionItemPanel>
									<ul className="col col-3-of-12 col-small-12-of-12 links list">
							...
							<AccordionItem>
								<AccordionItemHeading>
									<AccordionItemButton>
										<IconRemove className="icon-remove inlineblock" />
										<IconPlus className="icon-plus inlineblock" /> Locations
									</AccordionItemButton>
								</AccordionItemHeading>
								<AccordionItemPanel>
									<ul className="col col-3-of-12 col-small-12-of-12 links list">
										<li><a href="/?location=Portland, ME">Portland, ME</a></li>
										<li><a href="/?location=Mid-Coast, ME">Mid-Coast Maine</a></li>
										<li><a href="/?location=Biddeford, ME">Southern Maine</a></li>
									</ul>
								</AccordionItemPanel>
							</AccordionItem>
						</Accordion>
							...
							<div className="row footer-footer">
								<div className="col col-6-of-12 col-small-12-of-12">
									<ul className="list list--inline social-links">
										<li><a href="https://instagram.com/getradplaid" className="show-shareinstagram" target="_blank"><IconInstagram /></a></li>
										<li><a href="https://twitter.com/getradplaid" className="show-sharetwitter" target="_blank"><IconTwitter /></a></li>
										<li><a href="https://medium.com/radplaid" className="show-sharemedium" target="_blank"><IconMedium /></a></li>
										<li><a href="https://facebook.com/radplaid" className="show-sharefacebook" target="_blank"><IconFacebook /></a></li>
									</ul>
								</div>
								<div className="col col-6-of-12 col-small-12-of-12 text-right">
									<small className="typography-small" style={{ verticalAlign: 'middle' }}>Made with <IconHeart className="icon--small fill-secondary inlineblock" /> in Portland, ME</small>
								</div>
							</div>
						</div>
			...
			<footer>
				<div className="grid">
					<div className="row">
						<ul className="col col-3-of-12 col-small-12-of-12 links list">
							<li className="typography-small-headline text-uppercase">Rad Plaid</li>
							{!this.props.user && (
								<React.Fragment>
									<li><a href="#" onClick={this.onChangePage} name="signup">{SIGNUP_BUTTON}</a></li>
									<li>
						...
						<ul className="col col-3-of-12 col-small-12-of-12 links list">
							<li className="typography-small-headline text-uppercase">Artists &amp; Venues</li>
							<li><Link to="/add/1" onClick={this.onChangePage} name="addshow" title="Add Your Events">Add Your Events</Link></li>
							{/*<li><Link to="/widget-builder">Event Widget</Link></li>*/}
							<li><a href="https://forms.gle/YwHhRfgong94bqZS6" title="Submit News" target="_blank">Submit News</a></li>
							<li><a href="mailto:hello@getradplaid.com" title="Contact Us">Contact Us</a></li>
						</ul>

						<ul className="col col-3-of-12 col-small-12-of-12 links list">
							<li className="typography-small-headline text-uppercase">Locations</li>
							<li>
								<a href="/?location=Portland, ME">Portland, ME</a>
							</li>
							<li>
								<a href="/?location=Mid-Coast, ME">Mid-Coast Maine</a>
							</li>
							<li>
					...
					<br />
					<AppDownload theme="dark" className="text-left" />
...
const mapStateToProps = state => ({ app, user }) => ({
	user: user.user,
